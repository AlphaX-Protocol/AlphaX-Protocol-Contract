    ...
    PausableUpgradeable
{
  ...
  //  function WithdrawUsdtAndDepositToSpotVault( 
    //     address token,
    //     uint256 amount,
    //     uint256 expireTime,
    //     uint256 requestId,
    ...
    //    checkWithdrawSignatures(address(this), spotVault , amount , token , expireTime, requestId, allSigners, signatures); 

    //    IERC20(token).safeTransfer( spotVault, amount);

    //    emit TransferToSpotVault(token, amount, requestId);
    ...
    //     nonReentrant {  
    //     checkSpotSwapSignatures(owner, tokenIn, amountIn, tokenOut, minReturnAmount, expireTime,requestId, allSigners, signatures);
       
    //     ISpotVault(spotVault).spotSwap(owner, tokenIn, amountIn,tokenOut , minReturnAmount, exchangeData );
    ...
    //  function checkSpotSwapSignatures(  
    //     address owner,
    //     address tokenIn,
    //     uint256 amountIn,
    //     address tokenOut,
    ...
    //     // Try to insert the request ID. Will revert if the request id was invalid
    //     tryInsertRequestId(block.chainid, requestId, owner, amountIn, tokenIn);
